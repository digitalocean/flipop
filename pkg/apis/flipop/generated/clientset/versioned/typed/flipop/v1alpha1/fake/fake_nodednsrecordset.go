...
func (c *FakeNodeDNSRecordSets) Get(name string, options v1.GetOptions) (result *v1alpha1.NodeDNSRecordSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) List(opts v1.ListOptions) (result *v1alpha1.NodeDNSRecordSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeNodeDNSRecordSets) Create(nodeDNSRecordSet *v1alpha1.NodeDNSRecordSet) (result *v1alpha1.NodeDNSRecordSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) Update(nodeDNSRecordSet *v1alpha1.NodeDNSRecordSet) (result *v1alpha1.NodeDNSRecordSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) UpdateStatus(nodeDNSRecordSet *v1alpha1.NodeDNSRecordSet) (*v1alpha1.NodeDNSRecordSet, error) {
	obj, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeNodeDNSRecordSets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(nodednsrecordsetsResource, c.ns, listOptions)
...
func (c *FakeNodeDNSRecordSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.NodeDNSRecordSet, err error) {
	obj, err := c.Fake.
