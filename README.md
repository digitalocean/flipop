...
FLIPOP can be used to assign BYOIPs to K8s nodes by explicitely mentioning the list of BYOIPs in the `ips` list. If we mention just `desired_ips`, flipop will try to assign the Floating IPs.
---
